...
The same pattern (small `device.mk` additions + sepolicy fragments) applies to any AOSP device tree. Contributions for additional devices welcome — see [`github.com/Jibar-OS/JibarOS`](https://github.com/Jibar-OS/JibarOS) for the porting guide.
